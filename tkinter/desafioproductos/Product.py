...
class Product:
    ...
    def __init__(self, window):
        ...
        frame.grid(row=0, column=0, columnspan=40, pady=20)
    ...
    def add_product(self):
        if self.validation():
            ...
            self.message["text"] = f'Product {self.name.get()} added Succesfully'
    ...
    def delete_product(self):
        ...
        self.message['text'] = f'Record {name} deleted succesfully '
        self.get_products()
    ...
    def edit_records(self, new_name, name, new_price, old_price):
        ...
        self.message["text"] = f"Record {name} update Succesfully"
        self.get_products()
